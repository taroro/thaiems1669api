    ...
    <div class="content-main clearfix" style="margin: 70px 0 40px">
        <div class="row clearfix">
            ...
            <div class="col-md-3" style="padding-left: 25px;">
                ...
                <div class="row clearfix">
                    <div class="pre-scrollable" style="max-height:calc(100vh - 156px);" id="listAccident">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        $.ajax({
            url: 'http://10.0.0.33/api/accident',
            dataType: "jsonp",
            success: function (data){
                $.each( data, function( key, item ) {
                    var html = "<div class=\"panel panel-danger\" style=\"margin-right:10px;\">" +
                        "<div class=\"panel-heading\">" +
                        "<h3 class=\"panel-title\"><i class=\"fa fa-exclamation-triangle\" aria-hidden=\"true\"></i>" + item.accident_name + "</h3>" +
                        "</div>" +
                        "<div class=\"panel-body\"> " +
